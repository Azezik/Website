(function(root, factory){
  if (typeof module === 'object' && module.exports) {
    module.exports = factory(require('./ocr'), require('./config'), require('./ui'));
  } else {
    root.InvoiceEngine = factory(root.OCR, root.InvoiceConfig, root.UI);
  }
}(this, function(ocr, config, ui){
  const { tokensInRect, pctRectToPx, expandRect, normalizeSpace } = ocr;
  const { FieldMap } = ui;
