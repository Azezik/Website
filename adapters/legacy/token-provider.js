(function(root){
  function createLegacyTokenProvider(deps){
    if(root.SkinV2TokenProviderAdapter?.createSkinV2TokenProvider){
      return root.SkinV2TokenProviderAdapter.createSkinV2TokenProvider(deps);
    }
  ...
  root.LegacyTokenProviderAdapter = { createLegacyTokenProvider };
